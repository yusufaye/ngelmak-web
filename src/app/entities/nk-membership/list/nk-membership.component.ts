...
import { EntityArrayResponseType, MembershipService } from '../service/nk-membership.service';

@Component({
  standalone: true,
  selector: 'app-membership',
  templateUrl: './nk-membership.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class MembershipComponent implements OnInit {
  ...
  trackId = (_index: number, item: IMembership): number => this.membershipService.getMembershipIdentifier(item);
