...
export class UserPrivilegeComponent implements OnInit {
  ...
  protected userPrivilegeService = inject(
    UserPrivilegeService
  );
  ...
  delete(userPrivilege: IUserPrivilege): void {
    // const modalRef = this.modalService.open(UserPrivilegeDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    // modalRef.componentInstance.userPrivilege = userPrivilege;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.userPrivileges = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(
    data: IUserPrivilege[] | null
  ): IUserPrivilege[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.userPrivilegeService
      .query(queryObject)
